...
public:
  ...
  */
  ...
  virtual void computeSuperweaponTarget(
  ...
  */
  ...
  /// This will be asked by units when they look to get extra people to sight
  /// for
...
private:
  ...
  Int m_visionSpiedBy[MAX_PLAYER_COUNT]; ///< Reference count of having units
                                         ///< spied on by players.
  PlayerMaskType
      m_visionSpiedMask; ///< For quick lookup and edge triggered maintenance
